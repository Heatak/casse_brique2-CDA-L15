...
//            new Brique(225, 100, Color.red, 50, 30);
    ...
    public void demarrer() throws InterruptedException {
        ...
        listeBalle.add(new Balle(220, 400, Color.darkGray, 20, 3, -3));
...
//                case 0:
            ...
            for (int j = 1; j * 60 < HAUTEUR - 250; j++) {
                listeBrique.add(new Brique(i * 55, j * 55, new Color((float)Math.random(),(float)Math.random(),(float)Math.random()), 50, 30));
            }
        }
